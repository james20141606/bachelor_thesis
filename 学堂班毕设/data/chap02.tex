...
\subsection{Recurrent exRNA fragments are associated with the structural domain and/or protein binding}
...
\caption{Domain and background region’s potential to bind with RNA Binding Proteins}
\end{subfigure}
...
\subsection{Differential expression anlysis}
...
\subsection{feature selection algorithm}
